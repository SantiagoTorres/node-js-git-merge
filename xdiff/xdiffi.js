...
var xprepare = require("./xprepare.js");
...
module.exports.xdl_recs_cmp = xdl_recs_cmp;


module.exports.xdl_do_diff = function(mf1, mf2, xpp, xe) { 
  ...
  /* FIXME: This is apparently not executed and I don't want to impl more merge algos :/
  ...
  */
  ...
  if (xprepare.xdl_prepare_env(mf1, mf2, xpp, xe) < 0) {
      return -1;
  }
...
module.exports.xdl_change_compact = function (xdf, xdfo, flags) {
  ...
  while (true) {
    if (g.end == g.start) {    /* Move past the just-processed group: */
      if (group_next(xdf, g))
        break;
  ...
  //next: FIXME: this used to be a label and I had to inline it 
...
var recs_match = function(rec1, rec2, flags)
{
  ...
  return (rec1.ha == rec2.ha &&
    xprepare.xdl_recmatch(rec1.ptr, rec2));
}
...
module.exports.xdl_build_script = function(xe, xscr) {
  var cscr = null;
  var xch;
  ...
  /* TODO: please take away all of this vestigial memory management */
  xscr = cscr;
