...
var xdiff = require("./xdiff.js");
var xdiffi = require("./xdiffi.js");
...
var xdl_merge_cmp_lines = function(xe1, i1, xe2, i2, lineCount, flags) {
  ...
  for (i = 0; i < lineCount; i++) {
    var result = xutils.xdl_recmatch(rec1[i].ptr, rec2[i].ptr, flags);
    if (!result)
      return -1;
  }
  return 0;
...
module.exports.XDL_MERGE_ZEALOUS_ALNUM = xdiff.XDL_MERGE_ZEALOUS_ALNUM;
module.exports.Sxdmerge = Xdmerge;
module.exports.Xmparam = xdiff.Xmparam;
module.exports.Mmfile = xdiff.Mmfile;
