...
module.exports.xdl_guess_lines = function(mf, sample) {
  var nl = 0, size = mf.size, tsize = 0;
...
module.exports.xdl_hashbits = function (size) {
  var val = 1, bits = 0;
...
module.exports.xdl_hash_record_with_whitespace = function(data, _top, flags) {
...
module.exports.xdl_hash_record = function(i, data, _top, flags) {
  var ha = 5381;
  var ptr = data;
...
module.exports.xdl_recmatch = function(line, rec) {
